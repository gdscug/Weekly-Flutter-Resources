...
- [RaisedButton Documentation](https://api.flutter.dev/flutter/material/RaisedButton-class.html)
- [Navigator Documentation](https://api.flutter.dev/flutter/widgets/Navigator-class.html)
- [Create Rounded Button using RaisedButton](https://stackoverflow.com/questions/49991444/create-a-rounded-button-button-with-border-radius-in-flutter)
- [Navigate Between Screens](https://flutter.dev/docs/cookbook/navigation/navigation-basics)
...
- [PPT Week-1](https://docs.google.com/presentation/d/1btYVk9boGKidfKYDCW_qwfPxamqYM8jTqLJtt4OBjg4/edit?usp=sharing)
...
## Week 2 : Show Your Data with Custom ListView
### Documentation and References
- [Week-2 Stub Project](https://github.com/DSC-Gunadarma/Weekly2-Flutter-Stub-Project) 
- [Asset Week-2](https://drive.google.com/file/d/1w92tsirZV5qmmiJ_iWee8Mac2CrpFAAS/view?usp=sharing)
- [Tutorial Dart Language **(Reading)**](https://www.petanikode.com/belajar-dart/) 
- [Tutorial Dart Language **(Playlist Video Youtube)**](https://www.youtube.com/watch?v=IJlyhGV7-Fs&list=PLZQbl9Jhl-VDeCuNNp7C2SR1lFsIjQRQo)
- [OOP in Dart **Open in incognito Window**](https://medium.com/run-dart/dart-dartlang-introduction-object-oriented-programming-c3d79d94d303#:~:text=Dart%20supports%20all%20the%20features,%2C%20Interfaces%2C%20Polymorphism%2C%20etc.&text=6%20min%20read-,Dart%20supports%20all%20the%20features%20for%20Object%2Doriented%20programing%20paradigm,%2C%20Interfaces%2C%20Polymorphism%2C%20etc.)
- [ListView documentation](https://api.flutter.dev/flutter/widgets/ListView-class.html)
- [ListView Reading Material in Medium](https://medium.com/nusanet/flutter-listview-7de1759b4fb1)
- [ListView Reading Material in Medium](https://medium.com/@DakshHub/flutter-displaying-dynamic-contents-using-listview-builder-f2cedb1a19fb)
